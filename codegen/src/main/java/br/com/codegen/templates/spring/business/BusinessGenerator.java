package br.com.codegen.templates.spring.business;
...
public class BusinessGenerator {
	...
	private final String PACKAGE_NAME = "business";

	private String path;

	public BusinessGenerator(String path) {
		try {
	...
	public String execute(TemplateVO templateVO) {
		try {
			...
			velocityEngine.mergeTemplate("templates/spring/business.vm",
