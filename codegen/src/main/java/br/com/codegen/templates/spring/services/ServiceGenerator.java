package br.com.codegen.templates.spring.services;
...
public class ServiceGenerator {
	...
	private final String PACKAGE_NAME = "services";

	private String path;

	public ServiceGenerator(String path) {
		try {
	...
	public String execute(TemplateVO templateVO) {
		try {
			...
			velocityEngine.mergeTemplate("templates/spring/service.vm",
